  ...
  return (
    <div onClick={() => onTap(item)} style={{
      ...
      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
        ...
        {item.facebook && (
          <a href={item.facebook} target="_blank" rel="noreferrer" onClick={e => e.stopPropagation()} style={{ flex: 1, minWidth: 70, background: '#F7F3EE', borderRadius: 10, padding: '8px 0', fontSize: 12, fontWeight: 600, color: colors.textPrimary, textAlign: 'center', textDecoration: 'none' }}>
