    ...
    <div style={{ maxWidth: 430, margin: '0 auto', background: '#F7F3EE', minHeight: '100vh', paddingBottom: 80 }}>
      <div style={{ background: headerGradient, padding: '48px 20px 22px' }}>
        ...
        <div style={{ marginBottom: 14, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>
          ...
          <AddListingButton categorySlug="mosques" label="mosque" />
        </div>
        ...
        <div style={{ position: 'sticky', top: 0, zIndex: 10, background: '#F7F3EE', paddingBottom: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
            ...
            <div style={{ display: 'flex', background: 'white', borderRadius: 12, padding: 3, border: '1px solid rgba(0,0,0,0.08)' }}>
              ...
              <button onClick={() => navigate('/jummah/map')} style={{ padding: '8px 10px', borderRadius: 10, border: 'none', cursor: 'pointer', fontSize: 12, fontWeight: 600, background: 'transparent', color: '#3A4A5A', whiteSpace: 'nowrap' }}>🗺️ Map</button>
            </div>
          </div>
